...
def buff_calc(data):
    ...
    exp_buff_param = 0.75 if exp_count > 4 else 0.55
    proj_buff_param = 0.30 if proj_count > 2 else 0.2
    educ_buff_param = 0.25 if educ_count > 4 else 0.20
    cert_buff_param = 0.20 if cert_count > 4 else 0.15
    ref_buff_param = 0.45 if ref_count > 2 else 0.25
